...
const ProjectCard:FunctionComponent<{
  ...
  return (
    ...
    <div 
    className="absolute top-0 left-0 z-10 grid w-full h-auto p-2 text-black bg-gray-300 rounded-lg md:p-10 md:grid-cols-2 gap-x-12 dark:text-white dark:bg-dark-100 shadow-custom-light dark:shadow-custom-dark "
    >
